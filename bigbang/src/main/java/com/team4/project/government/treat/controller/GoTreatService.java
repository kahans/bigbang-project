...
public class GoTreatService {
	...
	// 한사람의 하나의 진료정보
	public GoGetTreatSub getOneTreat(String treatCode){
		return goTCDao.selectOneTreat(treatCode);
	}
		
	// 한사람의 진료리스트
	public List<GoGetTreatSub> getListTreatByCitizenId(String citizenId){
		return goTCDao.selectListTreatByCitizenId(citizenId);
	}
	
	// 한명의 의사에게 진료받은 여러사람의 진료리스트
	public List<GoGetTreatSub> getListTreatByDoctorId(String doctorId){
